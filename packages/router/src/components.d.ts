...
declare global {
  ...
  const HTMLStencilAsyncContentElement: {
  ...
  const HTMLStencilRouteLinkElement: {
  ...
  const HTMLStencilRouteSwitchElement: {
  ...
  const HTMLStencilRouteTitleElement: {
  ...
  const HTMLStencilRouterElement: {
  ...
  const HTMLStencilRouterPromptElement: {
  ...
  const HTMLStencilRouterRedirectElement: {
